...
export const users: User[] = [
  ...
  { id: 'user-1', name: 'Seán Ó Briain', email: generateEmail('Seán', 'Ó Briain', 'housing.gov.ie'), access: [{ departmentId: 'dept-1', departmentName: 'Housing, Local Government and Heritage', fullDepartment: true, unitIds: [], unitNames: [], role: 'admin' }], addedAt: '2024-01-15', addedBy: 'Marie O\'Sullivan' },
  { id: 'user-2', name: 'Aoife Ní Chonchúir', email: generateEmail('Aoife', 'Ní Chonchúir', 'housing.gov.ie'), access: [{ departmentId: 'dept-1', departmentName: 'Housing, Local Government and Heritage', fullDepartment: false, unitIds: ['unit-1', 'unit-2'], unitNames: ['Cork City Council', 'Dublin City Council'], role: 'editor' }], addedAt: '2024-02-01', addedBy: 'Marie O\'Sullivan' },
  { id: 'user-3', name: 'Ciarán Mac Carthaigh', email: generateEmail('Ciarán', 'Mac Carthaigh', 'housing.gov.ie'), access: [{ departmentId: 'dept-1', departmentName: 'Housing, Local Government and Heritage', fullDepartment: false, unitIds: ['unit-3', 'unit-4', 'unit-5'], unitNames: ['Galway County Council', 'Kilkenny County Council', 'Limerick City and County Council'], role: 'viewer' }], addedAt: '2024-02-10', addedBy: 'Patrick Murphy' },
  { id: 'user-4', name: 'Niamh Ní Dhomhnaill', email: generateEmail('Niamh', 'Ní Dhomhnaill', 'housing.gov.ie'), access: [{ departmentId: 'dept-1', departmentName: 'Housing, Local Government and Heritage', fullDepartment: false, unitIds: ['unit-6', 'unit-7'], unitNames: ['Waterford City and County Council', 'Fingal County Council'], role: 'editor' }], addedAt: '2024-02-15', addedBy: 'Marie O\'Sullivan' },
  { id: 'user-5', name: 'Pádraig Ó Suilleabháin', email: generateEmail('Pádraig', 'Ó Suilleabháin', 'housing.gov.ie'), access: [{ departmentId: 'dept-1', departmentName: 'Housing, Local Government and Heritage', fullDepartment: false, unitIds: ['unit-8'], unitNames: ['South Dublin County Council'], role: 'admin' }], addedAt: '2024-03-01', addedBy: 'Patrick Murphy' },
  { id: 'user-6', name: 'Máire Ní Bhriain', email: generateEmail('Máire', 'Ní Bhriain', 'housing.gov.ie'), access: [{ departmentId: 'dept-1', departmentName: 'Housing, Local Government and Heritage', fullDepartment: false, unitIds: ['unit-9', 'unit-10'], unitNames: ['Dún Laoghaire-Rathdown County Council', 'Kerry County Council'], role: 'viewer' }], addedAt: '2024-03-10', addedBy: 'Sinead Kelly' },
  { id: 'user-7', name: 'Eoin Mac Aoidh', email: generateEmail('Eoin', 'Mac Aoidh', 'housing.gov.ie'), access: [{ departmentId: 'dept-1', departmentName: 'Housing, Local Government and Heritage', fullDepartment: false, unitIds: ['unit-11', 'unit-12'], unitNames: ['Mayo County Council', 'Wexford County Council'], role: 'editor' }], addedAt: '2024-03-15', addedBy: 'Patrick Murphy' },
  { id: 'user-8', name: 'Síle Ní Mhurchú', email: generateEmail('Síle', 'Ní Mhurchú', 'housing.gov.ie'), access: [{ departmentId: 'dept-1', departmentName: 'Housing, Local Government and Heritage', fullDepartment: false, unitIds: ['unit-1'], unitNames: ['Cork City Council'], role: 'viewer' }], addedAt: '2024-03-20', addedBy: 'Marie O\'Sullivan' },
  { id: 'user-9', name: 'Tadhg Ó Ceallaigh', email: generateEmail('Tadhg', 'Ó Ceallaigh', 'housing.gov.ie'), access: [{ departmentId: 'dept-1', departmentName: 'Housing, Local Government and Heritage', fullDepartment: false, unitIds: ['unit-2'], unitNames: ['Dublin City Council'], role: 'admin' }], addedAt: '2024-04-01', addedBy: 'Patrick Murphy' },
  { id: 'user-10', name: 'Gráinne Ní Fhloinn', email: generateEmail('Gráinne', 'Ní Fhloinn', 'housing.gov.ie'), access: [{ departmentId: 'dept-1', departmentName: 'Housing, Local Government and Heritage', fullDepartment: false, unitIds: ['unit-2', 'unit-7'], unitNames: ['Dublin City Council', 'Fingal County Council'], role: 'editor' }], addedAt: '2024-04-05', addedBy: 'Sinead Kelly' },
  
  // Education Department users (8 users)
  { id: 'user-11', name: 'Oisín Ó Néill', email: generateEmail('Oisín', 'Ó Néill', 'education.gov.ie'), access: [{ departmentId: 'dept-2', departmentName: 'Education', fullDepartment: true, unitIds: [], unitNames: [], role: 'admin' }], addedAt: '2024-01-20', addedBy: 'Sinead Kelly' },
  { id: 'user-12', name: 'Siobhán Ní Riain', email: generateEmail('Siobhán', 'Ní Riain', 'education.gov.ie'), access: [{ departmentId: 'dept-2', departmentName: 'Education', fullDepartment: false, unitIds: ['unit-13', 'unit-14'], unitNames: ['Primary Schools Division', 'Secondary Schools Division'], role: 'editor' }], addedAt: '2024-02-01', addedBy: 'Sinead Kelly' },
  { id: 'user-13', name: 'Cormac Mac Giolla', email: generateEmail('Cormac', 'Mac Giolla', 'education.gov.ie'), access: [{ departmentId: 'dept-2', departmentName: 'Education', fullDepartment: false, unitIds: ['unit-15'], unitNames: ['Higher Education Division'], role: 'viewer' }], addedAt: '2024-02-10', addedBy: 'Patrick Murphy' },
  { id: 'user-14', name: 'Áine Ní Shé', email: generateEmail('Áine', 'Ní Shé', 'education.gov.ie'), access: [{ departmentId: 'dept-2', departmentName: 'Education', fullDepartment: false, unitIds: ['unit-16', 'unit-17'], unitNames: ['Special Education Division', 'Teacher Education Section'], role: 'admin' }], addedAt: '2024-02-15', addedBy: 'Sinead Kelly' },
  { id: 'user-15', name: 'Fionn Ó Dónaill', email: generateEmail('Fionn', 'Ó Dónaill', 'education.gov.ie'), access: [{ departmentId: 'dept-2', departmentName: 'Education', fullDepartment: false, unitIds: ['unit-18', 'unit-19', 'unit-20'], unitNames: ['Curriculum and Assessment Policy', 'School Transport Section', 'Statistics Section'], role: 'editor' }], addedAt: '2024-03-01', addedBy: 'Patrick Murphy' },
  { id: 'user-16', name: 'Caoimhe Ní Cheallaigh', email: generateEmail('Caoimhe', 'Ní Cheallaigh', 'education.gov.ie'), access: [{ departmentId: 'dept-2', departmentName: 'Education', fullDepartment: false, unitIds: ['unit-21'], unitNames: ['International Section'], role: 'viewer' }], addedAt: '2024-03-10', addedBy: 'Marie O\'Sullivan' },
  { id: 'user-17', name: 'Darragh Ó Murchú', email: generateEmail('Darragh', 'Ó Murchú', 'education.gov.ie'), access: [{ departmentId: 'dept-2', departmentName: 'Education', fullDepartment: false, unitIds: ['unit-22'], unitNames: ['ICT Policy Unit'], role: 'admin' }], addedAt: '2024-03-15', addedBy: 'Patrick Murphy' },
  { id: 'user-18', name: 'Róisín Ní Ghrádaigh', email: generateEmail('Róisín', 'Ní Ghrádaigh', 'education.gov.ie'), access: [{ departmentId: 'dept-2', departmentName: 'Education', fullDepartment: false, unitIds: ['unit-13'], unitNames: ['Primary Schools Division'], role: 'editor' }], addedAt: '2024-03-20', addedBy: 'Sinead Kelly' },
  
  // Health Department users (10 users)
  { id: 'user-19', name: 'Conor Ó Flannagáin', email: generateEmail('Conor', 'Ó Flannagáin', 'health.gov.ie'), access: [{ departmentId: 'dept-3', departmentName: 'Health', fullDepartment: true, unitIds: [], unitNames: [], role: 'admin' }], addedAt: '2024-01-18', addedBy: 'Aoife Brennan' },
  { id: 'user-20', name: 'Saoirse Ní Mhaoláin', email: generateEmail('Saoirse', 'Ní Mhaoláin', 'health.gov.ie'), access: [{ departmentId: 'dept-3', departmentName: 'Health', fullDepartment: false, unitIds: ['unit-23', 'unit-24'], unitNames: ['HSE Dublin North', 'HSE Dublin South'], role: 'editor' }], addedAt: '2024-01-25', addedBy: 'Aoife Brennan' },
  { id: 'user-21', name: 'Liam Ó Raghallaigh', email: generateEmail('Liam', 'Ó Raghallaigh', 'health.gov.ie'), access: [{ departmentId: 'dept-3', departmentName: 'Health', fullDepartment: false, unitIds: ['unit-25'], unitNames: ['HSE Cork'], role: 'viewer' }], addedAt: '2024-02-01', addedBy: 'Declan Walsh' },
  { id: 'user-22', name: 'Orla Ní Chonaill', email: generateEmail('Orla', 'Ní Chonaill', 'health.gov.ie'), access: [{ departmentId: 'dept-3', departmentName: 'Health', fullDepartment: false, unitIds: ['unit-26', 'unit-27'], unitNames: ['HSE Galway', 'HSE Limerick'], role: 'admin' }], addedAt: '2024-02-10', addedBy: 'Aoife Brennan' },
  { id: 'user-23', name: 'Declan Mac Suibhne', email: generateEmail('Declan', 'Mac Suibhne', 'health.gov.ie'), access: [{ departmentId: 'dept-3', departmentName: 'Health', fullDepartment: false, unitIds: ['unit-28', 'unit-29', 'unit-30'], unitNames: ['HSE Waterford', 'HSE Kerry', 'HSE Sligo'], role: 'editor' }], addedAt: '2024-02-15', addedBy: 'Declan Walsh' },
  { id: 'user-24', name: 'Clodagh Ní Fhearghail', email: generateEmail('Clodagh', 'Ní Fhearghail', 'health.gov.ie'), access: [{ departmentId: 'dept-3', departmentName: 'Health', fullDepartment: false, unitIds: ['unit-31', 'unit-32'], unitNames: ['HSE Donegal', 'HSE Mayo'], role: 'viewer' }], addedAt: '2024-02-20', addedBy: 'Aoife Brennan' },
  { id: 'user-25', name: 'Brendan Ó hEachthairn', email: generateEmail('Brendan', 'Ó hEachthairn', 'health.gov.ie'), access: [{ departmentId: 'dept-3', departmentName: 'Health', fullDepartment: false, unitIds: ['unit-33'], unitNames: ['Mental Health Division'], role: 'admin' }], addedAt: '2024-03-01', addedBy: 'Declan Walsh' },
  { id: 'user-26', name: 'Maeve Ní Bhraonáin', email: generateEmail('Maeve', 'Ní Bhraonáin', 'health.gov.ie'), access: [{ departmentId: 'dept-3', departmentName: 'Health', fullDepartment: false, unitIds: ['unit-34', 'unit-35'], unitNames: ['Primary Care Division', 'Acute Hospitals Division'], role: 'editor' }], addedAt: '2024-03-10', addedBy: 'Aoife Brennan' },
  { id: 'user-27', name: 'Cathal Mac Lochlainn', email: generateEmail('Cathal', 'Mac Lochlainn', 'health.gov.ie'), access: [{ departmentId: 'dept-3', departmentName: 'Health', fullDepartment: false, unitIds: ['unit-36'], unitNames: ['Community Healthcare Division'], role: 'viewer' }], addedAt: '2024-03-15', addedBy: 'Declan Walsh' },
  { id: 'user-28', name: 'Eimear Ní Dhuibhir', email: generateEmail('Eimear', 'Ní Dhuibhir', 'health.gov.ie'), access: [{ departmentId: 'dept-3', departmentName: 'Health', fullDepartment: false, unitIds: ['unit-37'], unitNames: ['National Ambulance Service'], role: 'admin' }], addedAt: '2024-03-20', addedBy: 'Aoife Brennan' },
  
  // Social Protection users (6 users)
  { id: 'user-29', name: 'Donal Ó Cathasaigh', email: generateEmail('Donal', 'Ó Cathasaigh', 'dsp.gov.ie'), access: [{ departmentId: 'dept-4', departmentName: 'Social Protection', fullDepartment: true, unitIds: [], unitNames: [], role: 'admin' }], addedAt: '2024-02-05', addedBy: 'Declan Walsh' },
  { id: 'user-30', name: 'Sorcha Ní Chonghaile', email: generateEmail('Sorcha', 'Ní Chonghaile', 'dsp.gov.ie'), access: [{ departmentId: 'dept-4', departmentName: 'Social Protection', fullDepartment: false, unitIds: ['unit-38', 'unit-39'], unitNames: ['Employment Services', 'Community Welfare'], role: 'editor' }], addedAt: '2024-02-10', addedBy: 'Sinead Kelly' },
  { id: 'user-31', name: 'Fergus Mac Giolla', email: generateEmail('Fergus', 'Mac Giolla', 'dsp.gov.ie'), access: [{ departmentId: 'dept-4', departmentName: 'Social Protection', fullDepartment: false, unitIds: ['unit-40', 'unit-41'], unitNames: ['Pensions Division', 'Child Benefit Section'], role: 'viewer' }], addedAt: '2024-02-15', addedBy: 'Declan Walsh' },
  { id: 'user-32', name: 'Deirdre Ní Shé', email: generateEmail('Deirdre', 'Ní Shé', 'dsp.gov.ie'), access: [{ departmentId: 'dept-4', departmentName: 'Social Protection', fullDepartment: false, unitIds: ['unit-42', 'unit-43'], unitNames: ['Disability Services', 'Jobseeker Services'], role: 'admin' }], addedAt: '2024-02-20', addedBy: 'Sinead Kelly' },
  { id: 'user-33', name: 'Colm Ó Dónaill', email: generateEmail('Colm', 'Ó Dónaill', 'dsp.gov.ie'), access: [{ departmentId: 'dept-4', departmentName: 'Social Protection', fullDepartment: false, unitIds: ['unit-44', 'unit-45'], unitNames: ['Carers Section', 'Maternity Benefit Section'], role: 'editor' }], addedAt: '2024-03-01', addedBy: 'Declan Walsh' },
  { id: 'user-34', name: 'Aisling Ní Cheallaigh', email: generateEmail('Aisling', 'Ní Cheallaigh', 'dsp.gov.ie'), access: [{ departmentId: 'dept-4', departmentName: 'Social Protection', fullDepartment: false, unitIds: ['unit-46', 'unit-47'], unitNames: ['PRSI Records', 'Appeals Office'], role: 'viewer' }], addedAt: '2024-03-10', addedBy: 'Sinead Kelly' },
  
  // Justice Department users (6 users)
  { id: 'user-35', name: 'Ruairí Ó Murchú', email: generateEmail('Ruairí', 'Ó Murchú', 'justice.gov.ie'), access: [{ departmentId: 'dept-9', departmentName: 'Justice', fullDepartment: true, unitIds: [], unitNames: [], role: 'admin' }], addedAt: '2024-01-22', addedBy: 'Marie O\'Sullivan' },
  { id: 'user-36', name: 'Fionnuala Ní Ghrádaigh', email: generateEmail('Fionnuala', 'Ní Ghrádaigh', 'justice.gov.ie'), access: [{ departmentId: 'dept-9', departmentName: 'Justice', fullDepartment: false, unitIds: ['unit-48', 'unit-49'], unitNames: ['An Garda Síochána Liaison', 'Irish Prison Service'], role: 'editor' }], addedAt: '2024-02-01', addedBy: 'Patrick Murphy' },
  { id: 'user-37', name: 'Diarmuid Mac Suibhne', email: generateEmail('Diarmuid', 'Mac Suibhne', 'justice.gov.ie'), access: [{ departmentId: 'dept-9', departmentName: 'Justice', fullDepartment: false, unitIds: ['unit-50', 'unit-51'], unitNames: ['Courts Service', 'Immigration Service'], role: 'viewer' }], addedAt: '2024-02-10', addedBy: 'Marie O\'Sullivan' },
  { id: 'user-38', name: 'Meadhbh Ní Fhloinn', email: generateEmail('Meadhbh', 'Ní Fhloinn', 'justice.gov.ie'), access: [{ departmentId: 'dept-9', departmentName: 'Justice', fullDepartment: false, unitIds: ['unit-52', 'unit-53'], unitNames: ['Legal Aid Board', 'Probation Service'], role: 'admin' }], addedAt: '2024-02-15', addedBy: 'Patrick Murphy' },
  { id: 'user-39', name: 'Tomás Ó Raghallaigh', email: generateEmail('Tomás', 'Ó Raghallaigh', 'justice.gov.ie'), access: [{ departmentId: 'dept-9', departmentName: 'Justice', fullDepartment: false, unitIds: ['unit-54', 'unit-55', 'unit-56'], unitNames: ['Data Protection Unit', 'Crime Policy Division', 'Civil Law Reform'], role: 'editor' }], addedAt: '2024-02-20', addedBy: 'Marie O\'Sullivan' },
  { id: 'user-40', name: 'Bríd Ní Mhaoláin', email: generateEmail('Bríd', 'Ní Mhaoláin', 'justice.gov.ie'), access: [{ departmentId: 'dept-9', departmentName: 'Justice', fullDepartment: false, unitIds: ['unit-57', 'unit-58'], unitNames: ['International Protection Office', 'Coroners Service'], role: 'viewer' }], addedAt: '2024-03-01', addedBy: 'Patrick Murphy' },
  
  // Multi-department access users (5 users) - demonstrating different roles per access
  { id: 'user-41', name: 'Oisín Mac Lochlainn', email: generateEmail('Oisín', 'Mac Lochlainn', 'gov.ie'), access: [{ departmentId: 'dept-1', departmentName: 'Housing, Local Government and Heritage', fullDepartment: false, unitIds: ['unit-1'], unitNames: ['Cork City Council'], role: 'admin' }, { departmentId: 'dept-3', departmentName: 'Health', fullDepartment: false, unitIds: ['unit-25'], unitNames: ['HSE Cork'], role: 'viewer' }], addedAt: '2024-02-25', addedBy: 'Marie O\'Sullivan' },
  { id: 'user-42', name: 'Siobhán Ó Cathasaigh', email: generateEmail('Siobhán', 'Ó Cathasaigh', 'gov.ie'), access: [{ departmentId: 'dept-2', departmentName: 'Education', fullDepartment: true, unitIds: [], unitNames: [], role: 'editor' }, { departmentId: 'dept-17', departmentName: 'Further and Higher Education, Research, Innovation and Science', fullDepartment: true, unitIds: [], unitNames: [], role: 'viewer' }], addedAt: '2024-03-05', addedBy: 'Sinead Kelly' },
  { id: 'user-43', name: 'Cormac Ní Bhraonáin', email: generateEmail('Cormac', 'Ní Bhraonáin', 'gov.ie'), access: [{ departmentId: 'dept-4', departmentName: 'Social Protection', fullDepartment: false, unitIds: ['unit-38'], unitNames: ['Employment Services'], role: 'viewer' }, { departmentId: 'dept-5', departmentName: 'Enterprise, Trade and Employment', fullDepartment: true, unitIds: [], unitNames: [], role: 'admin' }], addedAt: '2024-03-10', addedBy: 'Declan Walsh' },
  { id: 'user-44', name: 'Áine Mac Aoidh', email: generateEmail('Áine', 'Mac Aoidh', 'gov.ie'), access: [{ departmentId: 'dept-3', departmentName: 'Health', fullDepartment: false, unitIds: ['unit-33', 'unit-34'], unitNames: ['Mental Health Division', 'Primary Care Division'], role: 'editor' }, { departmentId: 'dept-15', departmentName: 'Children, Equality, Disability, Integration and Youth', fullDepartment: true, unitIds: [], unitNames: [], role: 'admin' }], addedAt: '2024-03-15', addedBy: 'Aoife Brennan' },
  { id: 'user-45', name: 'Fionn Ní Dhuibhir', email: generateEmail('Fionn', 'Ní Dhuibhir', 'gov.ie'), access: [{ departmentId: 'dept-9', departmentName: 'Justice', fullDepartment: false, unitIds: ['unit-51'], unitNames: ['Immigration Service'], role: 'admin' }, { departmentId: 'dept-12', departmentName: 'Foreign Affairs', fullDepartment: true, unitIds: [], unitNames: [], role: 'viewer' }], addedAt: '2024-03-20', addedBy: 'Patrick Murphy' },
];
...
export const activityLogs: ActivityLog[] = [
  ...
  { id: 'log-10', action: 'access_revoked', description: 'Revoked access for Ciarán Mac Carthaigh from Limerick City and County Council', performedBy: 'Patrick Murphy', performedByEmail: 'patrick.murphy@ogcio.gov.ie', timestamp: '2024-03-20T16:00:00Z', targetType: 'user', targetName: 'Ciarán Mac Carthaigh', metadata: { unit: 'Limerick City and County Council' } },
