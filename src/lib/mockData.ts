...
export const users: User[] = [
  ...
  { id: 'user-7', name: 'Eoin Mac Aoidh', email: generateEmail('Eoin', 'Mac Aoidh', 'housing.gov.ie'), access: [{ departmentId: 'dept-1', departmentName: 'Housing, Local Government and Heritage', fullDepartment: false, unitAccess: [{ unitId: 'unit-11', unitName: 'Mayo County Council', role: 'admin' }, { unitId: 'unit-12', unitName: 'Wexford County Council', role: 'viewer' }] }], addedAt: '2024-03-15', addedBy: 'Patrick Murphy' },
  { id: 'user-8', name: 'Síle Ní Mhurchú', email: generateEmail('Síle', 'Ní Mhurchú', 'housing.gov.ie'), access: [{ departmentId: 'dept-1', departmentName: 'Housing, Local Government and Heritage', fullDepartment: false, unitAccess: [{ unitId: 'unit-1', unitName: 'Cork City Council', role: 'viewer' }] }], addedAt: '2024-03-20', addedBy: 'Marie O\'Sullivan' },
  { id: 'user-9', name: 'Tadhg Ó Ceallaigh', email: generateEmail('Tadhg', 'Ó Ceallaigh', 'housing.gov.ie'), access: [{ departmentId: 'dept-1', departmentName: 'Housing, Local Government and Heritage', fullDepartment: false, unitAccess: [{ unitId: 'unit-2', unitName: 'Dublin City Council', role: 'admin' }] }], addedAt: '2024-04-01', addedBy: 'Patrick Murphy' },
  { id: 'user-10', name: 'Gráinne Ní Fhloinn', email: generateEmail('Gráinne', 'Ní Fhloinn', 'housing.gov.ie'), access: [{ departmentId: 'dept-1', departmentName: 'Housing, Local Government and Heritage', fullDepartment: false, unitAccess: [{ unitId: 'unit-2', unitName: 'Dublin City Council', role: 'editor' }, { unitId: 'unit-7', unitName: 'Fingal County Council', role: 'admin' }] }], addedAt: '2024-04-05', addedBy: 'Sinead Kelly' },
  
  // Education Department users (8 users)
  { id: 'user-11', name: 'Oisín Ó Néill', email: generateEmail('Oisín', 'Ó Néill', 'education.gov.ie'), access: [{ departmentId: 'dept-2', departmentName: 'Education', fullDepartment: true, fullDepartmentRole: 'admin', unitAccess: [] }], addedAt: '2024-01-20', addedBy: 'Sinead Kelly' },
  { id: 'user-12', name: 'Siobhán Ní Riain', email: generateEmail('Siobhán', 'Ní Riain', 'education.gov.ie'), access: [{ departmentId: 'dept-2', departmentName: 'Education', fullDepartment: false, unitAccess: [{ unitId: 'unit-13', unitName: 'Primary Schools Division', role: 'editor' }, { unitId: 'unit-14', unitName: 'Secondary Schools Division', role: 'viewer' }] }], addedAt: '2024-02-01', addedBy: 'Sinead Kelly' },
  { id: 'user-13', name: 'Cormac Mac Giolla', email: generateEmail('Cormac', 'Mac Giolla', 'education.gov.ie'), access: [{ departmentId: 'dept-2', departmentName: 'Education', fullDepartment: false, unitAccess: [{ unitId: 'unit-15', unitName: 'Higher Education Division', role: 'viewer' }] }], addedAt: '2024-02-10', addedBy: 'Patrick Murphy' },
  { id: 'user-14', name: 'Áine Ní Shé', email: generateEmail('Áine', 'Ní Shé', 'education.gov.ie'), access: [{ departmentId: 'dept-2', departmentName: 'Education', fullDepartment: false, unitAccess: [{ unitId: 'unit-16', unitName: 'Special Education Division', role: 'admin' }, { unitId: 'unit-17', unitName: 'Teacher Education Section', role: 'editor' }] }], addedAt: '2024-02-15', addedBy: 'Sinead Kelly' },
  { id: 'user-15', name: 'Fionn Ó Dónaill', email: generateEmail('Fionn', 'Ó Dónaill', 'education.gov.ie'), access: [{ departmentId: 'dept-2', departmentName: 'Education', fullDepartment: false, unitAccess: [{ unitId: 'unit-18', unitName: 'Curriculum and Assessment Policy', role: 'editor' }, { unitId: 'unit-19', unitName: 'School Transport Section', role: 'viewer' }, { unitId: 'unit-20', unitName: 'Statistics Section', role: 'admin' }] }], addedAt: '2024-03-01', addedBy: 'Patrick Murphy' },
  { id: 'user-16', name: 'Caoimhe Ní Cheallaigh', email: generateEmail('Caoimhe', 'Ní Cheallaigh', 'education.gov.ie'), access: [{ departmentId: 'dept-2', departmentName: 'Education', fullDepartment: false, unitAccess: [{ unitId: 'unit-21', unitName: 'International Section', role: 'viewer' }] }], addedAt: '2024-03-10', addedBy: 'Marie O\'Sullivan' },
  { id: 'user-17', name: 'Darragh Ó Murchú', email: generateEmail('Darragh', 'Ó Murchú', 'education.gov.ie'), access: [{ departmentId: 'dept-2', departmentName: 'Education', fullDepartment: false, unitAccess: [{ unitId: 'unit-22', unitName: 'ICT Policy Unit', role: 'admin' }] }], addedAt: '2024-03-15', addedBy: 'Patrick Murphy' },
  { id: 'user-18', name: 'Róisín Ní Ghrádaigh', email: generateEmail('Róisín', 'Ní Ghrádaigh', 'education.gov.ie'), access: [{ departmentId: 'dept-2', departmentName: 'Education', fullDepartment: false, unitAccess: [{ unitId: 'unit-13', unitName: 'Primary Schools Division', role: 'editor' }] }], addedAt: '2024-03-20', addedBy: 'Sinead Kelly' },
  
  // Health Department users (10 users)
  { id: 'user-19', name: 'Conor Ó Flannagáin', email: generateEmail('Conor', 'Ó Flannagáin', 'health.gov.ie'), access: [{ departmentId: 'dept-3', departmentName: 'Health', fullDepartment: true, fullDepartmentRole: 'admin', unitAccess: [] }], addedAt: '2024-01-18', addedBy: 'Aoife Brennan' },
  { id: 'user-20', name: 'Saoirse Ní Mhaoláin', email: generateEmail('Saoirse', 'Ní Mhaoláin', 'health.gov.ie'), access: [{ departmentId: 'dept-3', departmentName: 'Health', fullDepartment: false, unitAccess: [{ unitId: 'unit-23', unitName: 'HSE Dublin North', role: 'editor' }, { unitId: 'unit-24', unitName: 'HSE Dublin South', role: 'admin' }] }], addedAt: '2024-01-25', addedBy: 'Aoife Brennan' },
  { id: 'user-21', name: 'Liam Ó Raghallaigh', email: generateEmail('Liam', 'Ó Raghallaigh', 'health.gov.ie'), access: [{ departmentId: 'dept-3', departmentName: 'Health', fullDepartment: false, unitAccess: [{ unitId: 'unit-25', unitName: 'HSE Cork', role: 'viewer' }] }], addedAt: '2024-02-01', addedBy: 'Declan Walsh' },
  { id: 'user-22', name: 'Orla Ní Chonaill', email: generateEmail('Orla', 'Ní Chonaill', 'health.gov.ie'), access: [{ departmentId: 'dept-3', departmentName: 'Health', fullDepartment: false, unitAccess: [{ unitId: 'unit-26', unitName: 'HSE Galway', role: 'admin' }, { unitId: 'unit-27', unitName: 'HSE Limerick', role: 'viewer' }] }], addedAt: '2024-02-10', addedBy: 'Aoife Brennan' },
  { id: 'user-23', name: 'Declan Mac Suibhne', email: generateEmail('Declan', 'Mac Suibhne', 'health.gov.ie'), access: [{ departmentId: 'dept-3', departmentName: 'Health', fullDepartment: false, unitAccess: [{ unitId: 'unit-28', unitName: 'HSE Waterford', role: 'editor' }, { unitId: 'unit-29', unitName: 'HSE Kerry', role: 'viewer' }, { unitId: 'unit-30', unitName: 'HSE Sligo', role: 'admin' }] }], addedAt: '2024-02-15', addedBy: 'Declan Walsh' },
  { id: 'user-24', name: 'Clodagh Ní Fhearghail', email: generateEmail('Clodagh', 'Ní Fhearghail', 'health.gov.ie'), access: [{ departmentId: 'dept-3', departmentName: 'Health', fullDepartment: false, unitAccess: [{ unitId: 'unit-31', unitName: 'HSE Donegal', role: 'viewer' }, { unitId: 'unit-32', unitName: 'HSE Mayo', role: 'editor' }] }], addedAt: '2024-02-20', addedBy: 'Aoife Brennan' },
  { id: 'user-25', name: 'Brendan Ó hEachthairn', email: generateEmail('Brendan', 'Ó hEachthairn', 'health.gov.ie'), access: [{ departmentId: 'dept-3', departmentName: 'Health', fullDepartment: false, unitAccess: [{ unitId: 'unit-33', unitName: 'Mental Health Division', role: 'admin' }] }], addedAt: '2024-03-01', addedBy: 'Declan Walsh' },
  { id: 'user-26', name: 'Maeve Ní Bhraonáin', email: generateEmail('Maeve', 'Ní Bhraonáin', 'health.gov.ie'), access: [{ departmentId: 'dept-3', departmentName: 'Health', fullDepartment: false, unitAccess: [{ unitId: 'unit-34', unitName: 'Primary Care Division', role: 'editor' }, { unitId: 'unit-35', unitName: 'Acute Hospitals Division', role: 'viewer' }] }], addedAt: '2024-03-10', addedBy: 'Aoife Brennan' },
  { id: 'user-27', name: 'Cathal Mac Lochlainn', email: generateEmail('Cathal', 'Mac Lochlainn', 'health.gov.ie'), access: [{ departmentId: 'dept-3', departmentName: 'Health', fullDepartment: false, unitAccess: [{ unitId: 'unit-36', unitName: 'Community Healthcare Division', role: 'viewer' }] }], addedAt: '2024-03-15', addedBy: 'Declan Walsh' },
  { id: 'user-28', name: 'Eimear Ní Dhuibhir', email: generateEmail('Eimear', 'Ní Dhuibhir', 'health.gov.ie'), access: [{ departmentId: 'dept-3', departmentName: 'Health', fullDepartment: false, unitAccess: [{ unitId: 'unit-37', unitName: 'National Ambulance Service', role: 'admin' }] }], addedAt: '2024-03-20', addedBy: 'Aoife Brennan' },
  
  // Social Protection users (6 users)
  { id: 'user-29', name: 'Donal Ó Cathasaigh', email: generateEmail('Donal', 'Ó Cathasaigh', 'dsp.gov.ie'), access: [{ departmentId: 'dept-4', departmentName: 'Social Protection', fullDepartment: true, fullDepartmentRole: 'admin', unitAccess: [] }], addedAt: '2024-02-05', addedBy: 'Declan Walsh' },
  { id: 'user-30', name: 'Sorcha Ní Chonghaile', email: generateEmail('Sorcha', 'Ní Chonghaile', 'dsp.gov.ie'), access: [{ departmentId: 'dept-4', departmentName: 'Social Protection', fullDepartment: false, unitAccess: [{ unitId: 'unit-38', unitName: 'Employment Services', role: 'editor' }, { unitId: 'unit-39', unitName: 'Community Welfare', role: 'viewer' }] }], addedAt: '2024-02-10', addedBy: 'Sinead Kelly' },
  { id: 'user-31', name: 'Fergus Mac Giolla', email: generateEmail('Fergus', 'Mac Giolla', 'dsp.gov.ie'), access: [{ departmentId: 'dept-4', departmentName: 'Social Protection', fullDepartment: false, unitAccess: [{ unitId: 'unit-40', unitName: 'Pensions Division', role: 'viewer' }, { unitId: 'unit-41', unitName: 'Child Benefit Section', role: 'admin' }] }], addedAt: '2024-02-15', addedBy: 'Declan Walsh' },
  { id: 'user-32', name: 'Deirdre Ní Shé', email: generateEmail('Deirdre', 'Ní Shé', 'dsp.gov.ie'), access: [{ departmentId: 'dept-4', departmentName: 'Social Protection', fullDepartment: false, unitAccess: [{ unitId: 'unit-42', unitName: 'Disability Services', role: 'admin' }, { unitId: 'unit-43', unitName: 'Jobseeker Services', role: 'editor' }] }], addedAt: '2024-02-20', addedBy: 'Sinead Kelly' },
  { id: 'user-33', name: 'Colm Ó Dónaill', email: generateEmail('Colm', 'Ó Dónaill', 'dsp.gov.ie'), access: [{ departmentId: 'dept-4', departmentName: 'Social Protection', fullDepartment: false, unitAccess: [{ unitId: 'unit-44', unitName: 'Carers Section', role: 'editor' }, { unitId: 'unit-45', unitName: 'Maternity Benefit Section', role: 'viewer' }] }], addedAt: '2024-03-01', addedBy: 'Declan Walsh' },
  { id: 'user-34', name: 'Aisling Ní Cheallaigh', email: generateEmail('Aisling', 'Ní Cheallaigh', 'dsp.gov.ie'), access: [{ departmentId: 'dept-4', departmentName: 'Social Protection', fullDepartment: false, unitAccess: [{ unitId: 'unit-46', unitName: 'PRSI Records', role: 'viewer' }, { unitId: 'unit-47', unitName: 'Appeals Office', role: 'admin' }] }], addedAt: '2024-03-10', addedBy: 'Sinead Kelly' },
  
  // Justice Department users (6 users)
  { id: 'user-35', name: 'Ruairí Ó Murchú', email: generateEmail('Ruairí', 'Ó Murchú', 'justice.gov.ie'), access: [{ departmentId: 'dept-9', departmentName: 'Justice', fullDepartment: true, fullDepartmentRole: 'admin', unitAccess: [] }], addedAt: '2024-01-22', addedBy: 'Marie O\'Sullivan' },
  { id: 'user-36', name: 'Fionnuala Ní Ghrádaigh', email: generateEmail('Fionnuala', 'Ní Ghrádaigh', 'justice.gov.ie'), access: [{ departmentId: 'dept-9', departmentName: 'Justice', fullDepartment: false, unitAccess: [{ unitId: 'unit-48', unitName: 'An Garda Síochána Liaison', role: 'editor' }, { unitId: 'unit-49', unitName: 'Irish Prison Service', role: 'viewer' }] }], addedAt: '2024-02-01', addedBy: 'Patrick Murphy' },
  { id: 'user-37', name: 'Diarmuid Mac Suibhne', email: generateEmail('Diarmuid', 'Mac Suibhne', 'justice.gov.ie'), access: [{ departmentId: 'dept-9', departmentName: 'Justice', fullDepartment: false, unitAccess: [{ unitId: 'unit-50', unitName: 'Courts Service', role: 'viewer' }, { unitId: 'unit-51', unitName: 'Immigration Service', role: 'admin' }] }], addedAt: '2024-02-10', addedBy: 'Marie O\'Sullivan' },
  { id: 'user-38', name: 'Meadhbh Ní Fhloinn', email: generateEmail('Meadhbh', 'Ní Fhloinn', 'justice.gov.ie'), access: [{ departmentId: 'dept-9', departmentName: 'Justice', fullDepartment: false, unitAccess: [{ unitId: 'unit-52', unitName: 'Legal Aid Board', role: 'admin' }, { unitId: 'unit-53', unitName: 'Probation Service', role: 'editor' }] }], addedAt: '2024-02-15', addedBy: 'Patrick Murphy' },
  { id: 'user-39', name: 'Tomás Ó Raghallaigh', email: generateEmail('Tomás', 'Ó Raghallaigh', 'justice.gov.ie'), access: [{ departmentId: 'dept-9', departmentName: 'Justice', fullDepartment: false, unitAccess: [{ unitId: 'unit-54', unitName: 'Data Protection Unit', role: 'editor' }, { unitId: 'unit-55', unitName: 'Crime Policy Division', role: 'viewer' }, { unitId: 'unit-56', unitName: 'Civil Law Reform', role: 'admin' }] }], addedAt: '2024-02-20', addedBy: 'Marie O\'Sullivan' },
  { id: 'user-40', name: 'Bríd Ní Mhaoláin', email: generateEmail('Bríd', 'Ní Mhaoláin', 'justice.gov.ie'), access: [{ departmentId: 'dept-9', departmentName: 'Justice', fullDepartment: false, unitAccess: [{ unitId: 'unit-57', unitName: 'International Protection Office', role: 'viewer' }, { unitId: 'unit-58', unitName: 'Coroners Service', role: 'editor' }] }], addedAt: '2024-03-01', addedBy: 'Patrick Murphy' },
  
  // Multi-department access users (5 users) - demonstrating different roles per access
  { id: 'user-41', name: 'Oisín Mac Lochlainn', email: generateEmail('Oisín', 'Mac Lochlainn', 'gov.ie'), access: [{ departmentId: 'dept-1', departmentName: 'Housing, Local Government and Heritage', fullDepartment: false, unitAccess: [{ unitId: 'unit-1', unitName: 'Cork City Council', role: 'admin' }] }, { departmentId: 'dept-3', departmentName: 'Health', fullDepartment: false, unitAccess: [{ unitId: 'unit-25', unitName: 'HSE Cork', role: 'viewer' }] }], addedAt: '2024-02-25', addedBy: 'Marie O\'Sullivan' },
  { id: 'user-42', name: 'Siobhán Ó Cathasaigh', email: generateEmail('Siobhán', 'Ó Cathasaigh', 'gov.ie'), access: [{ departmentId: 'dept-2', departmentName: 'Education', fullDepartment: true, fullDepartmentRole: 'editor', unitAccess: [] }, { departmentId: 'dept-17', departmentName: 'Further and Higher Education, Research, Innovation and Science', fullDepartment: true, fullDepartmentRole: 'viewer', unitAccess: [] }], addedAt: '2024-03-05', addedBy: 'Sinead Kelly' },
  { id: 'user-43', name: 'Cormac Ní Bhraonáin', email: generateEmail('Cormac', 'Ní Bhraonáin', 'gov.ie'), access: [{ departmentId: 'dept-4', departmentName: 'Social Protection', fullDepartment: false, unitAccess: [{ unitId: 'unit-38', unitName: 'Employment Services', role: 'viewer' }] }, { departmentId: 'dept-5', departmentName: 'Enterprise, Trade and Employment', fullDepartment: true, fullDepartmentRole: 'admin', unitAccess: [] }], addedAt: '2024-03-10', addedBy: 'Declan Walsh' },
  { id: 'user-44', name: 'Áine Mac Aoidh', email: generateEmail('Áine', 'Mac Aoidh', 'gov.ie'), access: [{ departmentId: 'dept-3', departmentName: 'Health', fullDepartment: false, unitAccess: [{ unitId: 'unit-33', unitName: 'Mental Health Division', role: 'editor' }, { unitId: 'unit-34', unitName: 'Primary Care Division', role: 'admin' }] }, { departmentId: 'dept-15', departmentName: 'Children, Equality, Disability, Integration and Youth', fullDepartment: true, fullDepartmentRole: 'admin', unitAccess: [] }], addedAt: '2024-03-15', addedBy: 'Aoife Brennan' },
  { id: 'user-45', name: 'Fionn Ní Dhuibhir', email: generateEmail('Fionn', 'Ní Dhuibhir', 'gov.ie'), access: [{ departmentId: 'dept-9', departmentName: 'Justice', fullDepartment: false, unitAccess: [{ unitId: 'unit-51', unitName: 'Immigration Service', role: 'admin' }] }, { departmentId: 'dept-12', departmentName: 'Foreign Affairs', fullDepartment: true, fullDepartmentRole: 'viewer', unitAccess: [] }], addedAt: '2024-03-20', addedBy: 'Patrick Murphy' },
];
...
export function getUsersByUnitId(unitId: string): User[] {
  return users.filter(u => 
    u.access.some(a => a.unitAccess.some(ua => ua.unitId === unitId))
  );
}
