...
export const activityLogs: ActivityLog[] = [
  ...
  { id: 'log-9', action: 'access_granted', description: 'Granted Siobhán Ní Riain access to Primary Schools Division, Secondary Schools Division', performedBy: 'John Murphy', performedByEmail: 'patrick.murphy@gov.ie', timestamp: '2024-02-05T09:45:00', targetType: 'user', targetName: 'Siobhán Ní Riain' },
  { id: 'log-10', action: 'user_invited', description: 'Invited Ciarán Mac Carthaigh with access to multiple units in Housing', performedBy: 'John Murphy', performedByEmail: 'patrick.murphy@gov.ie', timestamp: '2024-02-10T11:00:00', targetType: 'user', targetName: 'Ciarán Mac Carthaigh' },
  ...
  { id: 'log-19', action: 'access_granted', description: 'Granted Bríd Ní Cheallaigh access to An Garda Síochána Liaison, Irish Prison Service', performedBy: 'John Murphy', performedByEmail: 'patrick.murphy@gov.ie', timestamp: '2024-02-01T14:15:00', targetType: 'user', targetName: 'Bríd Ní Cheallaigh' },
...
export const admins: Admin[] = [
  ...
  { id: 'admin-2', name: 'John Murphy', email: 'patrick.murphy@gov.ie', role: 'admin', status: 'active', addedAt: '2024-01-22', addedBy: 'Marie O\'Sullivan' },
